...
export default function Services() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message = `Hello, I am *${nama}*${brand ? ` from *${brand}*` : ""}.\n\n${pesan}`;
      ...
      <section className="bg-white py-20">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <p className="mb-4 text-black">Fill in the form below to contact our admin via WhatsApp.</p>
